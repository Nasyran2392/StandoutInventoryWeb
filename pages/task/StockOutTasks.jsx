...
const StockOutTasks = ({ inputs, title }) => {
  ...
  const handleAddItem = async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, "StockOutTasks"), newData);
  
      // Update inventory quantities
      await Promise.all(
        Object.entries(selectedProducts).map(async ([productId, quantity]) => {
          ...
          if (inventoryDoc.exists()) {
            ...
            throw new Error(`Inventory document not found for product with ID ${productId}`);
          }
        })
      );
      ...
      await emailjs.send("service_xhuz367", "template_jbnfjla", {
      ...
      // Clear form data and selected products
      setData({});
      setSelectedProducts({});
      setShowModal(true);
  ...
  const handleCloseModal = () => {
    setShowModal(false);
    // Optionally, you can navigate back here as well
    navigate(-1);
  };
  

  // Function to update inventory quantities
  const updateInventoryQuantities = (productId, quantity) => {
          ...
          <div className="rights">
            <form onSubmit={handleAddItem}>
              <div className="formInput">
                ...
                <select id="assignedStorekeeperId" onChange={handleInput}>
              ...
              <div className="formInput">
                ...
                <select id="assignedClientId" onChange={handleInput}>
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p className="sentence3"> Note: that the quantity changes are temporary. If the Storekeeper tries to Reject this task, the quantity will be sent back into the database.</p>
